 ...
 * @author Brandon Tate
 */
public class BTWebView extends WebView implements
		TextSelectionJavascriptInterfaceListener, OnTouchListener,
...
//				 +
//				 "script.type='text/javascript';script.src='file://android_asset/test.js';"
//				 +
//				 "document.getElementsByTagName('head').item(0).appendChild(script);"
//				 + "})()");
//				 String js = "function(){alert(\"hello world\");}";
//				 view.loadUrl("javascript:" + js);
//				 view.loadUrl("javascript:document.write('hello')");
//				injectJSFromAsset(view, "android.selection.js");
//				injectJSFromAsset(view, "jquery.js");
//				injectJSFromAsset(view, "rangy-core.js");
//				injectJSFromAsset(view, "rangy-serializer.js");
				injectJSFromAsset(view, "test.js");
//				view.loadUrl("javascript:(function() { "
//						+ "document.getElementsByTagName('body')[0].style.color = 'red'; "
//						+ "alert(\"hello world\");"
//				+ "var script=document.createElement('script');"
//				+ "script.type='text/javascript';"
////				+ "script.src='file:///android_asset/"+fileName+"';"
//				 +"script.innerHTML='function test(){alert(\"hello\");}';"
//				+ "document.getElementsByTagName('head').item(0).appendChild(script);"
//				+ "})()");
			}
		...
		mTextSelectionJSInterface = new TextSelectionJavascriptInterface(
				context, this);
...
//		this.loadUrl(filePath);
		this.loadUrl("http://www.voanews.com/content/thai-pm-survives-noconfidence-vote-protests-continue/1799355.html");
	...
	public void onDragEnd() {
		...
		if (mLastTouchedSelectionHandle == SELECTION_START_HANDLE && startX > 0
				&& startY > 0) {
			String saveStartString = String.format(
					"javascript: android.selection.setStartPos(%f, %f);",
					startX, startY);
			loadUrl(saveStartString);
		}

		if (mLastTouchedSelectionHandle == SELECTION_END_HANDLE && endX > 0
				&& endY > 0) {
			String saveEndString = String.format(
					"javascript: android.selection.setEndPos(%f, %f);", endX,
					endY);
	 ...
	 * @return
	 */
	protected void handleSelection(String range, String text,
			String handleBounds) {
		try {
			...
			handleRect.bottom = (int) (getDensityDependentValue(
					selectionBoundsObject.getInt("bottom"), getContext()) * scale);
	...
	protected Rect getContextMenuBounds(String menuBounds) {
		try {
			...
			displayRect.bottom = (int) (getDensityDependentValue(
					menuBoundsObject.getInt("bottom") + 25, getContext()) * scale);
	...
	private void injectJSFromAsset(WebView view, String fileName) {
		String jsContent =ReadFromfile(fileName, mContext);
		view.loadUrl("javascript:(function() { "
//						+ "document.getElementsByTagName('body')[0].style.color = 'red'; "
//						+ "alert(\"hello world\");"
				+ "var script=document.createElement('script');"
